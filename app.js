...
gsap.from('.third-frame > .container> .row >.col-12',{scrollTrigger:'.third-frame > .container', opacity:0, delay:1, duration:1, ease:"sine.out", stagger:0.2})
gsap.from('footer',{scrollTrigger:'footer', opacity:0, delay:0.2, duration:1, ease:"sine.out"} )
gsap.from(['.first-footer','.second-footer','.third-footer'],{scrollTrigger:'footer', y:10, delay:0.5, duration:1, ease:"back.out", stagger:0.5} )
